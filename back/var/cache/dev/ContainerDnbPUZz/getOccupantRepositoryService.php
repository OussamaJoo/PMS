 ...
 */
class getOccupantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OccupantRepository' shared autowired service.
     *
     * @return \App\Repository\OccupantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OccupantRepository.php';

        return $container->privates['App\\Repository\\OccupantRepository'] = new \App\Repository\OccupantRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

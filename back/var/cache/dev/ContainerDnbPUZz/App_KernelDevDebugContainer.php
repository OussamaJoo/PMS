...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'monolog.logger.db' => 'getMonolog_Logger_DbService',
            'request_stack' => 'getRequestStackService',
            'router' => 'getRouterService',
        ];
        $this->fileMap = [
            'App\\Controller\\AvailibilityController' => 'getAvailibilityControllerService',
            'App\\Controller\\DispoController' => 'getDispoControllerService',
            'App\\Controller\\EmailSenderController' => 'getEmailSenderControllerService',
            'App\\Controller\\EtabController' => 'getEtabControllerService',
            'App\\Controller\\MealPlanController' => 'getMealPlanControllerService',
            'App\\Controller\\PrixController' => 'getPrixControllerService',
            ...
            'App\\Controller\\TypologieController' => 'getTypologieControllerService',
        ...
        $this->privates['service_container'] = function () {
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'RequestListener.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Utility'.\DIRECTORY_SEPARATOR.'DbProcessor.php';
    ...
    {
        return $this->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('umO+nJPNHR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->pushHandler(($this->privates['monolog.handler.null_internal'] ??= new \Monolog\Handler\NullHandler()));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\MealPlanRepository' => ['privates', 'App\\Repository\\MealPlanRepository', 'getMealPlanRepositoryService', true],
            'App\\Repository\\OccupantRepository' => ['privates', 'App\\Repository\\OccupantRepository', 'getOccupantRepositoryService', true],
            'App\\Repository\\PrixRepository' => ['privates', 'App\\Repository\\PrixRepository', 'getPrixRepositoryService', true],
            ...
            'App\\Repository\\TypeEtablissementRepository' => ['privates', 'App\\Repository\\TypeEtablissementRepository', 'getTypeEtablissementRepositoryService', true],
            'App\\Repository\\TypologieRepository' => ['privates', 'App\\Repository\\TypologieRepository', 'getTypologieRepositoryService', true],
            ...
            'App\\Repository\\MealPlanRepository' => '?',
            'App\\Repository\\OccupantRepository' => '?',
            'App\\Repository\\PrixRepository' => '?',
            'App\\Repository\\ReservationRepository' => '?',
            'App\\Repository\\RoleRepository' => '?',
            'App\\Repository\\TypeEtablissementRepository' => '?',
            'App\\Repository\\TypologieRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $a->pushHandler(($this->privates['monolog.handler.null_internal'] ??= new \Monolog\Handler\NullHandler()));
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'App\\EventListener\\RequestListener')] function () {
            return ($this->privates['App\\EventListener\\RequestListener'] ?? $this->getRequestListenerService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [0 => #[\Closure(name: 'acme_api.event.authentication_success_listener', class: 'App\\EventListener\\JWTCreatedListener')] function () {
     ...
     */
    protected function getMonolog_Logger_DbService()
    {
        $this->services['monolog.logger.db'] = $instance = new \Symfony\Bridge\Monolog\Logger('db');

        $instance->pushHandler(($this->privates['monolog.dbHandler'] ?? $this->getMonolog_DbHandlerService()));
    ...
    /**
     * Gets the private '.service_locator.ziK_mic' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_ZiKMicService()
    {
        return $this->privates['.service_locator.ziK_mic'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        $a = ($this->services['monolog.logger.db'] ?? $this->getMonolog_Logger_DbService());

        if (isset($this->privates['App\\EventListener\\RequestListener'])) {
            return $this->privates['App\\EventListener\\RequestListener'];
        }

        return $this->privates['App\\EventListener\\RequestListener'] = new \App\EventListener\RequestListener($a);
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1nw4zuhm6N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DyFMmM6x8u', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jlGw28djqe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $a = ($this->privates['validator'] ?? $this->getValidatorService());
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GD9lLkcVjq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vnuzPD6kBk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
     ...
     */
    protected function getMonolog_DbHandlerService()
    {
        $a = ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService());

        if (isset($this->privates['monolog.dbHandler'])) {
            return $this->privates['monolog.dbHandler'];
        }

        $this->privates['monolog.dbHandler'] = $instance = new \App\Utility\DbHandler($a);

        $instance->pushProcessor(new \App\Utility\DbProcessor(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
        ...
        ]), ['login' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
        ...
        ]), 'api' => new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        $a = ($this->privates['.service_locator.ziK_mic'] ?? $this->get_ServiceLocator_ZiKMicService());
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), 1 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 2 => $e, 3 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($f, [], $g), 4 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $g), 5 => $e, 6 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $k, $f, $g), 7 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $l, $f), 8 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($f, true), 9 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 10 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 11 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 13 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $l, $k, $m, $b, $g, $n, [], $a), 14 => new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $l, $k, $b, $g, $n, NULL, $h, $a), 15 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $g), 17 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $g, $c, $o, NULL)), 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 23 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 24 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($m, $k, $l, NULL), 'page', 'pagination', $h, $b), $h, $k, ($this->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), 25 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 26 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $l, $m), 27 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $d, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getValidatorService()
    {
        ...
        if (isset($this->privates['validator'])) {
            return $this->privates['validator'];
        }

        return $this->privates['validator'] = $a->getValidator();
    }

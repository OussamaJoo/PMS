 ...
 */
class getMessenger_Transport_AsyncHighService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.asyncHigh' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.asyncHigh'])) {
            return $container->privates['messenger.transport.asyncHigh'];
        }

        return $container->privates['messenger.transport.asyncHigh'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN_High'), ['transport_name' => 'asyncHigh'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}

 ...
 */
class getMessenger_Transport_AsyncLowService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.asyncLow' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.asyncLow'])) {
            return $container->privates['messenger.transport.asyncLow'];
        }

        return $container->privates['messenger.transport.asyncLow'] = $a->createTransport($container->getEnv('MESSENGER_TRANSPORT_DSN_Low'), ['transport_name' => 'asyncLow'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}

 ...
 */
class getTypologieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypologieRepository' shared autowired service.
     *
     * @return \App\Repository\TypologieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypologieRepository.php';

        return $container->privates['App\\Repository\\TypologieRepository'] = new \App\Repository\TypologieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

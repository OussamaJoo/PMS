 ...
 */
class getMealPlanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MealPlanRepository' shared autowired service.
     *
     * @return \App\Repository\MealPlanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MealPlanRepository.php';

        return $container->privates['App\\Repository\\MealPlanRepository'] = new \App\Repository\MealPlanRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

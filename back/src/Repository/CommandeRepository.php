...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    public function annulerCommande(int $id){
        $updateEtat = $this->createQueryBuilder('c')
        ->update(Commande::class, 'c')
        ->set('c.etat', "'Annulée'")
        ->where('c.id = :idCmd')
        ->setParameter('idCmd', $id)
        ->getQuery();
    ...
    public function findByIdEatb(int $id): array {
        return $this->createQueryBuilder('c')
            ->andWhere('c.etablissement = :param')
                ->setParameter('param', $id)
                ->getQuery()
                ->getResult();
    }

    public function findByIdClient(int $id): array {
        return $this->createQueryBuilder('c')
            ->andWhere('c.client = :param')
                ->setParameter('param', $id)
                ->getQuery()
                ->getResult();
    }

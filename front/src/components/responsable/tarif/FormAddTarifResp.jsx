...
import { saveTarif2 } from '../../../redux/actions/tarifAction'
...
const FormAddTarifResp = () => {
  ...
  const savecarre = e => {
    ...
    if (tarif.dateDe == '' || tarif.dateAu == '' ||  tarif.nomTypologie == '' || tarif.montant == '') {
      ...
      dispatch(saveTarif2(tarif, navigate))
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              ...
              <Link className='ml-1 btn bg-white' to={'/responsable/tarifs'}>Annuler</Link>
            </div>
            <div className="col-sm-6">
...
export default FormAddTarifResp